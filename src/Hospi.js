...
export default class Hospi extends Component {
    ...
    render() {
        ...
        <label htmlFor="tab-1" tabIndex="0"></label>
          <input id="tab-1" type="radio" name="tabs" checked aria-hidden="true"></input>
        <h2>Policy</h2>
        <div>
        <p>Here at this confluence of art, talent and competitions, a multitude of crowd turns up. It is we, the hospitality team that caters to the needs of almost every individual that sets foot in our campus.</p>
        ...
        <li>You will be given accommodation only after it has been confirmed by the Hospitality committee of PECFEST.</li>
        ...
        <label htmlFor="tab-2" tabIndex="0"></label>
        <input id="tab-2" type="radio" name="tabs" ariaHidden="true"></input>
        <h2>Reaching PEC</h2>
        <div>
        ...
        <label htmlFor="tab-3" tabIndex="0"></label>
        <input id="tab-3" type="radio" name="tabs" ariaHidden="true"></input>
        <h2>Charges</h2>
        <div>
        ...
        <label htmlFor="tab-4" tabIndex="0"></label>
        <input id="tab-4" type="radio" name="tabs" ariaHidden="true"></input>
        <h2>Contacts</h2>
        <div>
